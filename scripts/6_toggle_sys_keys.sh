...
# SLAVE_KEYBOARD_ID=3
#### Preferably use names, as IDs change frequently
SYSTEM_KEYBOARD_ID="AT Translated Set 2 keyboard"
SLAVE_KEYBOARD_ID=3
# DEVICE_ENABLED_STATUS="Device Enabled (180): 1"
# DEVICE_DISABLED_STATUS="Device Enabled (180): 0"

DEVICE_STATUS=$(xinput list-props "$SYSTEM_KEYBOARD_ID" | awk '/^\tDevice Enabled \([0-9]+\):\t[01]/ {print $NF}')
