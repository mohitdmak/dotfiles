...
# Putty:
bindkey "\eh" dirhistory_zle_dirhistory_back
# GNU screen:
bindkey "\eh" dirhistory_zle_dirhistory_back
...
bindkey "\el" dirhistory_zle_dirhistory_future
bindkey "\el" dirhistory_zle_dirhistory_future
...
# Putty:
bindkey "\ej" dirhistory_zle_dirhistory_up
# GNU screen:
bindkey "\ej" dirhistory_zle_dirhistory_up
...
bindkey "\ek" dirhistory_zle_dirhistory_down
bindkey "\ek" dirhistory_zle_dirhistory_down
