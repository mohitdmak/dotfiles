#!/bin/bash
notify-send "Setting low power mechanisms in place . . ."

# /home/mohitdmak/.config/batteryPopup/i3-lowbattery-mechanism.sh
/home/arch/.config/batteryPopup/i3-lowbattery-mechanism.sh
